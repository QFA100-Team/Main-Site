            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <!-- General Details -->
                        <h4 style="text-align: center; margin-bottom: 20px;"><u>General Details</u></h4>
                        ...
                        <!-- VATSIM Details Details -->
                        <br><h4 style="text-align: center; margin-bottom: 20px;"><u>VATSIM Details</u></h4>

                        <!-- VATSIM CID -->
                        <div class="row mb-3">
                            <label for="vatsim_cid" class="col-md-4 col-form-label text-md-end">VATSIM CID</label>
                            <div class="col-md-6">
                                <input id="vatsim_cid" type="text" class="form-control @error('vatsim_cid') is-invalid @enderror" name="vatsim_cid" value="{{ old('vatsim_cid') }}" required autocomplete="vatsim_cid" autofocus>
                        ...
                        <!-- Password Details -->
                        <br><h4 style="text-align: center; margin-bottom: 20px;"><u>User Password</u></h4>
